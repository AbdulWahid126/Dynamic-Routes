...
export default function IndonesiaCard() {
  return (
    <div className="bg-gradient-to-r from-white via-green-500 to-green-600 min-h-screen pt-64">
      ...
      <Card className="w-full bg-white">
        ...
        <CardContent>
          <dl className="grid grid-cols-3 gap-4 text-sm">
            ...
            <dd className="col-span-2">Pakistan</dd>
            
            <dt className="font-semibold">Capital:</dt>
            <dd className="col-span-2">Islamabad</dd>
            
            <dt className="font-semibold">Population:</dt>
            <dd className="col-span-2">235.8 million</dd>
          </dl>
        </CardContent>
      </Card>
      <style jsx>{`
