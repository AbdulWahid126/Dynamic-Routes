...
export default function IndonesiaCard() {
  return (
    <div className="bg-gradient-to-t from-green-500 via-red-500 to-green-500 min-h-screen pt-64">
      ...
      <Card className="w-full bg-white">
        ...
        <CardContent>
          <dl className="grid grid-cols-3 gap-4 text-sm">
            ...
            <dd className="col-span-2">Bangladesh</dd>
            
            <dt className="font-semibold">Capital:</dt>
            <dd className="col-span-2">Dhaka</dd>
            
            <dt className="font-semibold">Population:</dt>
            <dd className="col-span-2">171.2 million</dd>
          </dl>
        </CardContent>
      </Card>
      <style jsx>{`
