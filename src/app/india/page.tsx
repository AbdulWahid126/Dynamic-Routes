...
export default function IndonesiaCard() {
  return (
    <div className="bg-gradient-to-t from-green-500 via-white to-orange-400 min-h-screen pt-64">
      ...
      <Card className="w-full bg-white">
        ...
        <CardContent>
          <dl className="grid grid-cols-3 gap-4 text-sm">
            ...
            <dd className="col-span-2">India</dd>
            
            <dt className="font-semibold">Capital:</dt>
            <dd className="col-span-2">New Delhi</dd>
            
            <dt className="font-semibold">Population:</dt>
            <dd className="col-span-2">1.417 billion</dd>
          </dl>
        </CardContent>
      </Card>
      <style jsx>{`
